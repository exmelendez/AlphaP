...
import com.example.android.alphap.Ridita.AboutUsFragment;
...
public class CreateJoinGameActivity extends AppCompatActivity {
    ...
    public void AboutUs(View view) {
        FrameLayout container = (FrameLayout) findViewById(R.id.aboutus_container);
        container.setVisibility(View.VISIBLE);
        getSupportFragmentManager().beginTransaction().replace(R.id.aboutus_container, new AboutUsFragment()).commit();
