...
public class SwipeListener implements View.OnTouchListener {
    ...
    public SwipeListener(View card, final SwipeCallback callback, ViewGroup parent, int initialX, int initialY, float rotation,
                         float opacityEnd) {
        this.card = card;
    ...
    private ViewPropertyAnimator resetCardPosition() {
        ...
        return card.animate()
                ...
                .x(initialX)
                .y((parent.getHeight()/2)-card.getHeight()/2)
                .rotation(0)
                .translationX(0);
    }
